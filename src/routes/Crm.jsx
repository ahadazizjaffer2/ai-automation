...
const calls = [
  ...
  },
  {
    ...
    name: "Emily Carter",
    avatar:
      "https://s3-alpha-sig.figma.com/img/c5f3/e84e/4fb2f97bf20e33c2b8cdf9197e1f2409?Expires=1741564800&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=k0Pgv~SnS1HG-3jj4WyeozE4GXVYpBnxgHWQRBz1m0ufyD04WpA5PjOhZEux8AqIh73kZ4UQZBt2Lw1V2Nsd83WZUm8mEkade8p~Rnr6KSMysZmO8Mv0kJuQnM6TTIGG05Czd5dHPUeD4KwVn11w8JMgkzlk82Q5iPUZqMWZLMWY3Up4yRJ0Vlpo7E7y4XnkCkRwKGXnECxwHzAphCum1yY~MQvDkrCfwBksGlQqA6laZNPuLaGhiFMc5HdP1Go2Aom~x29r7iZUygikzeF9p82mGCMPCRdup1ws98jaFXcn~yuq0t0LEwN4S5Eb5bvEo1GkemvRely0bH-piVkEZQ__",
    phone: "+1263 263513",
    date: "4 hours ago",
    duration: "54:230000000",
    bgColor: "bg-yellow-100",
  },
  {
    ...
    name: "James Harrison",
    avatar:
      "https://s3-alpha-sig.figma.com/img/afac/9044/1bd1b90f58b13b3dfe5637587e1b9661?Expires=1741564800&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=hZaJTeiHMtAhzF0mzQMmpkDUh-7avxHcOP-zvd16gSFWASUQ8-PQGei8q321bz9DPoGyEKIBtPVl-x9FKbWoC1EaUp384DYHTDdJlQRBt9TOZs8zRr6poYGmVNk15L-wa4BBFydAbk1uHo081eN3-dyi1hIcH4YmwL1h4IzMi8lnMo4Z5KINfXUvE4gzA-y2-jYAD4Tzip2uL9hTod-gsDFMXHLbQx4Ftl0Uufs5cG6pnBNuNOVRowcWjDDSftVVqB2J8NhV6WvgVGwAF-4mQ3QFGiWH653f4dxWNIAea9G3hniSYcT800qrv5kj2ouDBrgm~IkzzAe~VW0zPmeGfw__",
    initials: "JH",
    phone: "+1263 263513",
    date: "Yesterday",
    duration: "54:230000000",
  ...
  },
  {
    ...
    name: "Olivia Bennett",
    avatar:
      "https://s3-alpha-sig.figma.com/img/b52b/ff87/4bd5e2c4056e2551724da86e02902466?Expires=1741564800&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=eOAGmt7-rcQLSTD1Uvx8ckUBaduhmCRhRaSuSvHvNYSkMmPN1vt0DtBcIl7AE0yx3rk3561v75b6XrnAFnMdEkcWEIkLR5N4-ao6ZuABD4h31TcSdklnw5c9c4PLGkt50YQ1asl7b6po34yCwLyJ3M3W8CBKIGZZVZdAFOuTq6uZ4BTJSSa~EU~Od-AZBKSnnoms2e3FpyRTLc4Y1Zh4HpYpUDpeBmLVaXXVbrzAAyRdOTVPPsOBB5Re8-Pqcx-~iNviVTPyqRfa2sh2dpXydMfDhZr1lOgsG8F19EXUX5b0RFM3Uo91iy0mq9txnXQhGdFoqw6Lvdj-JiYsoDWclw__",
    phone: "+1263 263513",
    date: "June 2025",
    duration: "54:230000000",
    bgColor: "bg-green-100",
...
const meetings = [
  {
    ...
    lead: "Alexis Sanchez",
    avatar:
      "https://s3-alpha-sig.figma.com/img/b303/3293/64981872de114f9afc9909268c41d532?Expires=1741564800&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=URL1KYG3YLKQ89ddu0Jv1TknY~LtQQm4vrS4MT6UO~0MTMshLNI5NQTrJuCL79W2hFegObJrrbhnkD~lX2cR2m9yaP6a8iW8PZ8q0KGOR2GF64isOkuSozI54zgUP9hDU8rEFWU5erXwuwhwgXJ1NtuzBXP2J9fQwocbL4R-qYjLrMYGS2KrM3FNZ31U1~L18YLYwkQfOphOZv6SBvFEH9jPbjNj66YCmMrUDC0GOOJfag65yc4u546JnCc3XQx7Uq2UpJ-ViBOv1VjQ3CgGyqrl5E2Hp11Z6fSSsiSBfQYnRB4LtnafLLCvdJ5Nm9Qvc7e0EMpPsdm8izUgR6xmWQ__",
    date: "27 Feb 2025",
    time: "06 minutes ago",
    createdBy: "Quickpipe AI",
    isAI: true,
  ...
  },
  {
    ...
    lead: "Ruben Schleifer",
    avatar:
      "https://s3-alpha-sig.figma.com/img/ae49/d0da/6115d464049091b9698d07b84562a8f0?Expires=1741564800&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=kgeen2FpNLgv3BcZknG3W-~zL8O1m8BTAiJB-gBBbbxfLAsOSLkql3~rFms~l8dEi3CjzVyxnm7IWEm-d2At-UXDDjteybAmYUWfjYJbZYPhDBJqlYsZTV3WON1u2rpX6KiOKCRjaBs8YXTBNOFTuPYjcHwL~W0TTicsR2bR75VKQx1lqqFO1wA1aU3iITRqRlVhG91~R7DrVC8~xvy0s06xYuizao6WlS8zy-PPixaK4GDYw8oTY66dXQwncShOvPxKwQb2aMZ8mSRVik1bHrNNnpKGGbq1mpvbf5HPNqXb8i-5wu6rx8PIyyRSeH-fGdHaSq391TcTAH75ipISiA__",
    date: "27 Feb 2025",
    time: "06 minutes ago",
    createdBy: "Beeto Leru",
    isAI: false,
  ...
  },
  {
    ...
    lead: "Rayna Vetrovs",
    avatar:
      "https://s3-alpha-sig.figma.com/img/b333/a10d/f8c23fab456b1b430a98b7405fb49665?Expires=1741564800&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=NbQfy3MRcNWFqJmOnGMb0A52Zqh6ve7Svq6yIPwjBi-5w8CumHKoaO~rYMr3BW3b6AeM3yfaD7W~A0vw93q8TmUVWAiWEt34iCaawNPTrwaKERehUzFUoNyrGFDesBOPjMrkOS3sKs61g5s4q1SfMJq-rsUxXp10TkChwnMYfg9JofNbrGFETstK7h5B7kqvwQkvaRKkOSrusC185AXbvUJ~tlGAaGIVO7Ko1lyKDAe8WA3x9yoah7lThXw6qMXJTh~DIH2dK9MLGLxRlODO5~u7Ljy63B8jIabenWnmE8vYh4XzWoHd0JaetfCqlfz2TjR2lskQV~7JUQza8jsH1w__",
    date: "27 Feb 2025",
    time: "06 minutes ago",
    createdBy: "Quickpipe AI",
    isAI: true,
...
export default function Crm() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 ">
      <div className="container mx-auto pl-2 sm:px-4 py-4 sm:py-6">
        {/* Navigation Tabs */}
        <div className="border-b border-gray-200 mb-6 overflow-x-auto md:overflow-hidden">
          <nav className="flex -mb-px min-w-max">
            {["Accounts", "People", "Opportunities", "Calls", "Meetings"].map((tab) => (
              <button
                key={tab}
                onClick={() => setActiveTab(tab)}
                className={`mr-4 md:mr-8 py-4 px-1 border-b-2 font-medium text-sm whitespace-nowrap ${
                  activeTab === tab
                    ? "border-teal-500 text-teal-600"
                    : "border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300"
                }`}
          ...
          <div className="flex flex-col md:flex-row justify-between mb-6 gap-4">
            ...
            <div className="flex flex-wrap gap-4">
              <div className="relative inline-block text-left">
                ...
                {isOpen && (
                  <div className="absolute z-10 mt-2 right-0 sm:right-auto bg-white shadow-md w-44 rounded-lg">
                    <ul className="py-2 text-sm text-gray-700">
                      {listItems.map((val, index) => (
                        <li key={index} className="px-4 py-2 flex gap-2 items-center hover:bg-gray-100">
                          {val.icon} {val.name}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-4 md:gap-6 w-full">
                  ...
                  <div className="flex items-center">
                    <div className="flex -space-x-1 sm:-space-x-2 mr-2">
                      {account.contactAvatars.map((avatar, index) => (
                        <div
                          key={index}
                          className={`w-5 h-5 sm:w-6 sm:h-6 rounded-full flex items-center justify-center text-xs text-white border-2 border-white ${
                            index % 3 === 0 ? "bg-blue-500" : index % 3 === 1 ? "bg-yellow-500" : "bg-green-500"
                          }`}
                        >
                          {avatar}
          ...
          {activeTab === "People" && (
            <div className="col-span-full w-full overflow-x-auto -mx-4 px-4 sm:mx-0 sm:px-0">
              <table className="w-full table-fixed">
                <thead>
                  <tr className="border-b text-sm text-muted-foreground">
                    <th className="whitespace-nowrap px-2 sm:px-4 py-2 sm:py-3 text-left font-medium w-[40px]">
                      <input type="checkbox" className="rounded border-muted cursor-pointer" />
                    </th>
                    <th className="whitespace-nowrap px-2 sm:px-4 py-2 sm:py-3 text-left font-medium text-gray-400 w-[200px]">
                      EMAIL
                    </th>
                    <th className="whitespace-nowrap px-2 sm:px-4 py-2 sm:py-3 text-left font-medium text-gray-400 w-[180px]">
                      CONTACT
                    </th>
                    <th className="whitespace-nowrap px-2 sm:px-4 py-2 sm:py-3 text-left font-medium text-gray-400 w-[180px]">
                      EMAIL PROVIDER
                ...
                <tbody>
                  {people.map((person, idx) => (
                    <tr key={idx} className="border-b text-sm">
                      ...
                      <td className="px-2 sm:px-4 py-2 sm:py-3 text-gray-600">{person.email}</td>
                      <td className="px-2 sm:px-4 py-2 sm:py-3">{person.contact}</td>
                      <td className="px-2 sm:px-4 py-2 sm:py-3">
                        <div className="flex items-center">
                          {person.provider === "Microsoft" ? (
                            <>
                      ...
                      <td className="px-2 sm:px-4 py-2 sm:py-3">{person.company}</td>
                      <td className="px-2 sm:px-4 py-2 sm:py-3 text-blue-500">{person.website}</td>
                      <td className="px-2 sm:px-4 py-2 sm:py-3">{person.title}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
              ...
              <table className="w-full table-fixed">
                <thead>
                  <tr className="border-b text-sm text-muted-foreground">
                    ...
                    <th className="whitespace-nowrap px-2 sm:px-4 py-2 sm:py-3 text-left font-medium text-gray-400 w-[120px]">
                      Notes
                    </th>
                  </tr>
                </thead>
                <tbody>
                  {calls.map((call) => (
                    <tr key={call.id} className="border-b text-sm">
                      ...
                      <td className="px-2 sm:px-4 py-2 sm:py-3 text-gray-600">{call.phone}</td>
                      <td className="px-2 sm:px-4 py-2 sm:py-3 text-gray-600">{call.date}</td>
                      <td className="px-2 sm:px-4 py-2 sm:py-3 text-gray-600">{call.duration}</td>
                      <td className="px-2 sm:px-4 py-2 sm:py-3">
                        <button className="text-blue-500 hover:text-blue-600">View</button>
                      </td>
                    </tr>
          ...
          {activeTab === "Opportunities" && (
            ...
            <div className="col-span-full w-full overflow-x-auto -mx-4 px-4 sm:mx-0 sm:px-0">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                ...
                <button className="inline-flex items-center px-3 sm:px-4 py-2 border border-transparent text-xs sm:text-sm font-medium rounded-md shadow-sm text-white bg-orange-500 hover:bg-orange-600 whitespace-nowrap">
                  <Phone className="mr-2 h-4 w-4" />
                  Call with AI
                </button>
              </div>
              <div className=" w-full">
                <table className="table-auto w-full">
                  <thead>
                    <tr className="border-b text-sm text-muted-foreground">
                      <th className="whitespace-nowrap px-2 sm:px-4 py-2 sm:py-3 text-left font-medium w-[40px] min-w-[40px]">
                        <input type="checkbox" className="rounded border-muted cursor-pointer" />
                      </th>
                      <th className="whitespace-nowrap px-2 sm:px-4 py-2 sm:py-3 text-left font-medium text-gray-400 min-w-[120px]">
                        OPPORTUNITY
                      </th>
                      <th className="whitespace-nowrap px-2 sm:px-4 py-2 sm:py-3 text-left font-medium text-gray-400 min-w-[120px]">
                        CONTACT NAME
                      </th>
                      <th className="whitespace-nowrap px-2 sm:px-4 py-2 sm:py-3 text-left font-medium text-gray-400 min-w-[80px]">
                        AMOUNT
                      </th>
                      <th className="whitespace-nowrap px-2 sm:px-4 py-2 sm:py-3 text-left font-medium text-gray-400 min-w-[100px]">
                        OWNER
                      </th>
                      <th className="whitespace-nowrap px-2 sm:px-4 py-2 sm:py-3 text-left font-medium text-gray-400 min-w-[120px]">
                        SOURCE
                      </th>
                      <th className="whitespace-nowrap px-2 sm:px-4 py-2 sm:py-3 text-left font-medium text-gray-400 min-w-[150px]">
                        EXPECTED CLOSING DATE
                      </th>
                      <th className="whitespace-nowrap px-2 sm:px-4 py-2 sm:py-3 text-left font-medium text-gray-400 min-w-[150px]">
                        ACTUAL CLOSING DATE
                  ...
                  <tbody>
                    {opportunities.map((opp) => (
                      <tr key={opp.id} className="border-b text-sm">
                        ...
                        <td className="px-2 sm:px-4 py-2 sm:py-3 text-blue-600 hover:underline cursor-pointer">
                          {opp.opportunity}
                        </td>
                        <td className="px-2 sm:px-4 py-2 sm:py-3 text-blue-600 hover:underline cursor-pointer">
                          {opp.contact}
                        </td>
                        <td className="px-2 sm:px-4 py-2 sm:py-3 text-gray-600">{opp.amount}</td>
                        <td className="px-2 sm:px-4 py-2 sm:py-3">
                          <div className="inline-flex items-center px-2 py-1 rounded-md bg-blue-50 text-blue-600">
                            {opp.owner}
                          </div>
                        </td>
                        <td className="px-2 sm:px-4 py-2 sm:py-3 text-gray-600">{opp.source}</td>
                        <td className="px-2 sm:px-4 py-2 sm:py-3 text-gray-600">{opp.expectedClosing}</td>
                        <td className="px-2 sm:px-4 py-2 sm:py-3 text-gray-600">{opp.actualClosing}</td>
                        <td className="px-2 sm:px-4 py-2 sm:py-3 text-gray-600">{opp.lastInteraction}</td>
                        <td className="px-2 sm:px-4 py-2 sm:py-3 text-gray-600">{opp.stage}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
          ...
          {activeTab === "Meetings" && (
            <div className="col-span-full w-full overflow-x-auto -mx-4 px-4 sm:mx-0 sm:px-0">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                ...
                <button
                  type="button"
                  className="inline-flex items-center px-3 sm:px-4 py-2 border border-transparent text-xs sm:text-sm font-medium rounded-md shadow-sm text-white bg-teal-600 hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 whitespace-nowrap"
                >
                  <Plus className="mr-2 h-5 w-5" />
                  New Meeting
                </button>
              ...
              <table className="w-full table-fixed">
                <thead>
                  <tr className="border-b text-sm text-muted-foreground">
                    <th className="whitespace-nowrap px-2 sm:px-4 py-2 sm:py-3 text-left font-medium text-gray-400 w-[250px]">
                      Lead
                    </th>
                    <th className="whitespace-nowrap px-2 sm:px-4 py-2 sm:py-3 text-left font-medium text-gray-400 w-[180px]">
                      Date
                ...
                <tbody>
                  {meetings.map((meeting) => (
                    <tr key={meeting.id} className="border-b text-sm">
                      ...
                      <td className="px-2 sm:px-4 py-2 sm:py-3 text-gray-600">{meeting.date}</td>
                      <td className="px-2 sm:px-4 py-2 sm:py-3 text-gray-600">{meeting.time}</td>
                      <td className="px-2 sm:px-4 py-2 sm:py-3">
                        {meeting.isAI ? (
                          <div className="inline-flex items-center px-2 py-1 rounded-md bg-blue-50 text-blue-600">
                            <Sparkles className="w-4 h-4 mr-1" />
