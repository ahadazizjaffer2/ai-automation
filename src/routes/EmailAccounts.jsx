...
const EmailAccounts = () => {
  ...
  const AccountsSelectionPage = () => (
    <div className="p-4 md:p-24 px-auto pt-[40px] bg-white min-h-screen flex justify-center flex-col">
        ...
        <div className="bg-white min-h-screen pl-[10px] md:pr-[20px] pt-[10px] md:pt-[35px] text-gray-400 flex flex-col justify-center align-center text-sm">
          <div className="flex items-center justify-between mb-4 flex-col md:flex-row sm:gap-2">
            ...
            <div className="flex gap-4 items-center ">
              <button className="flex items-center px-2 md:px-4 py-1 md:py-2 border border-gray-300 rounded-full text-sm">
                All Statuses
              </button>
              <button className="flex items-center px-2 md:px-4 py-1 md:py-2 border border-gray-300 rounded-full">
                Oldest First
              </button>
              <button className="px-2 md:px-4 py-1 md:py-2 bg-[#15A395] text-white rounded-full"
